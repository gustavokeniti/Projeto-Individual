...
function preencherQues(req, res) {
    ...
    var mediaGeral = req.body.mediaGeralServer;
    ...
    if (idade == undefined) {
        ...
        questionarioModel.preencherQues(idade, altura, posicao, arremesso, passe, drible, controle, defesa, mediaGeral, fkjogador)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
